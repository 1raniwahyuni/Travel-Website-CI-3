		...
		<div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="blog_content">
                        <div class="blog_title text-center"><?= $konten->judul_konten ?></div>
                        <div class="blog_meta text-center">
                            <ul>
                                <li style="font-size: medium;" >Posted on <?= $konten->tgl_konten ?></a></li>
                                <li style="font-size: medium;">Ditulis Oleh <?= $konten->nama_penulis ?></a></li>
                            </ul>
                        </div>
                        <div class="blog_image text-center">
                            <img src="<?= base_url('foto/gambar_konten/'.$konten->gambar_konten) ?>" style="width: 80%;">
                        </div><br><br>
                        <div class="sub_judul text-center">
                            <h3><?= $konten->sub_judul ?></h3>
                        </div>
                        <div class="isi-konten text-justify">
                            <p><?= $konten->isi_konten ?></p>
                        </div>
                        <div class="back_button_container text-center">
                            <a href="<?= base_url('') ?>" class="btn btn-primary mx-auto">Back to Home</a>
                        </div>
                    </div>
		        </div>
	        </div>
