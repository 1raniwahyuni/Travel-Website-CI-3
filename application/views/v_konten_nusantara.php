            ...
            <div class="col-lg-12">
                ...
                <style>
                    ...
                    <div class="row events_row justify-content-center"> 
                        <?php foreach ($konten_nusantara as $key => $value) { ?>
                            <div class="col-lg-4 events_col">
                                <div class="course">
                                    <div class="">
                                        <img src="<?= base_url('foto/gambar_konten/'.$value->gambar_konten) ?>" width="360px" height="250px">
                                    </div>
                                    <div class="course_body">
                                        <h3 class="course_title">
                                            <a href="<?= base_url('home/detail_konten_nusantara/'.$value->id_konten) ?>">           
                                                <?= $value->judul_konten ?>
                                            </a>
                                        </h3>
