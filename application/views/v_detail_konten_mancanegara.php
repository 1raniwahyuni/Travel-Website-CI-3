                ...
                <div class="col">
                    <div class="breadcrumbs">
                        <ul>
                            ...
                            <li>Detail Konten Mancanegara</li>
                        </ul>
                    </div>
                </div>
            </div>
		...
		<div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="blog_content">
                        <div class="blog_title text-center"><?= $konten_mancanegara->judul_konten ?></div>
                        <div class="blog_meta text-center">
                            <ul>
                                <li style="font-size: medium;" >Posted on <?= $konten_mancanegara->tgl_konten ?></a></li>
                                <li style="font-size: medium;">Ditulis Oleh <?= $konten_mancanegara->nama_penulis ?></a></li>
                            </ul>
                        </div>
                        <div class="blog_image text-center">
                            <img src="<?= base_url('foto/gambar_konten/'.$konten_mancanegara->gambar_konten) ?>" style="width: 80%;">
                        </div><br><br>
                        <div class="sub_judul text-center">
                            <h3><?= $konten_mancanegara->sub_judul ?></h3>
                        </div>
