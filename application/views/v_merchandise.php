                            ...
                            <div class="col-lg-4 event_col">
                                <div class="event event_left">
                                    <div class="event_image">
                                        <img src="<?= base_url('foto/gambar_merchandise/'.$value->gambar_merchandise) ?>" width="350px" height="250px">
                                    </div>
                                    <div class="event_body d-flex flex-row align-items-start justify-content-start">
                                        <div class="event_content">
                                            <h3 class="course_title">
                                                <a href="<?= base_url('home/detail_merchandise/'.$value->id_merchandise) ?>">
                                                    <?= $value->nama_merchandise ?>
                                                </a>
                                            </h3>
                                            <div class="event_info_container">
                                                <div class="event_info text-center">
                                                    <h5>Rp. <?= number_format($value->harga_merchandise, 0, ',', '.') ?></h5> 
                                                </div>
                                                    <a href="<?= base_url('home/detail_merchandise/'.$value->id_merchandise) ?>" class="btn btn-primary">Order Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
