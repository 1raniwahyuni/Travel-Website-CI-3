		...
		<div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="blog_content">
                        <div class="blog_title text-center"><?= $artikel->judul_artikel ?></div>
                        <div class="blog_meta text-center">
                            <ul>
                                <li style="font-size: medium;" >Posted on <?= $artikel->tgl_artikel ?></a></li>
                                <li style="font-size: medium;">Diposting Oleh <?= $artikel->username ?></a></li>
                            </ul>
                        </div>
                        <div class="blog_image text-center">
                            <img src="<?= base_url('foto/gambar_artikel/'.$artikel->gambar_artikel) ?>" style="width: 80%;">
                        </div><br><br>
                        <div class="isi-artikel text-justify">
                            <p><?= $artikel->isi_artikel ?></p>
                        </div>
                        <div class="back_button_container text-center">
                            <a href="<?= base_url('home/artikel') ?>" class="btn btn-primary mx-auto">Back to Artikel</a>
                        </div>
                    </div>
		        </div>
	        </div>
